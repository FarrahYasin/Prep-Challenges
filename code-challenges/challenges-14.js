...
const replaceWords = (str) => {
    // write your code here
    const wordReplace = str.split(' ');
    if(wordReplace.indexOf('I') != -1)
        wordReplace.splice(wordReplace.indexOf('I'), 1, 'We');
    
    if(wordReplace.indexOf('am') != -1)
        wordReplace.splice(wordReplace.indexOf('am'), 1, 'are');

    if(wordReplace.indexOf('was') != -1)
        wordReplace.splice(wordReplace.indexOf('was'), 1, 'were');

    return wordReplace.join(' ');
